...
console.log('期待する値はtrue:', isOddNumber(9));
console.log('期待する値はfalse:', isOddNumber(14));
...
function factorial(num) {
  let result = 1;
  for (let i = num; i > 0; i--) {
    result *= i; //result = result * iと同じ
  }
  return result;
}

// ここにconsole.logを使って「4」「5」を引数に渡したときの結果値を出力する
console.log('4を入力すると期待される値は24である', factorial(4));
console.log('5を入力すると期待される値は120である', factorial(5));
...
const convertFirstCharacterToUpper = (text) => {
  return text.charAt(0).toUpperCase() + text.slice(1)
}

// ここにconsole.logを使って「'hello'」「'world'」を引数に渡したときの結果値を出力する
console.log('helloを入力すると期待される値はHello', convertFirstCharacterToUpper('hello'));
console.log('worldを入力すると期待される値はworld', convertFirstCharacterToUpper('world'));